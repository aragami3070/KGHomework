...
namespace Smirnov251HW2 {
	...
	float ejik[] = {
		...
		// яблоко
		1.3f, 2.8f, 1.04f, 2.8f,  // яблоко влево
		1.1f, 2.6f, 0.9f, 3.2f,  // яблоко влево вверх
		0.9f, 3.2f, 0.7f, 3.f,  // яблоко влево вниз
		0.7f, 3.f, 1.1f, 2.6f,  // яблоко вправо вниз
		0.9f, 2.8f, 0.5f, 2.8f,  // яблоко влево
		0.5f, 2.8f, 0.5f, 2.6f,  // яблоко вниз
		0.5f, 2.6f, 0.1f, 2.f,  // яблоко влево вниз
		0.1f, 2.f, 0.1f, 1.6f,  // яблоко вниз
		0.1f, 1.6f, 0.5f, 1.f,  // яблоко вправо вниз
		0.5f, 1.f, 0.95f, 1.f,  // яблоко вправо
		0.5f, 2.6f, 0.7f, 2.4f,  // яблоко вправо вниз
		0.7f, 2.4f, 0.7f, 2.7f,  // яблоко вверх
		0.7f, 2.7f, 0.9f, 2.8f,  // яблоко вправо вверх
		0.7f, 2.6f, 0.9f, 2.4f,  // яблоко вправо вниз
		0.9f, 2.4f, 1.3f, 2.4f,  // яблоко вправо вниз
